...
trainset_path = '../data/protein_trainset.pickle'
testset_path  = '../data/protein_testset.pickle'
dataset_path = '../Study/data/protein/'
model_path = '../models/protein/'
result_path= '../results/protein/'
...
if not os.path.exists( trainset_path ) or not os.path.exists( testset_path ):
    ...
    trainset = pd.DataFrame({'image_path': map(lambda x: os.path.join( trainset_dir, x ), os.listdir(trainset_dir)),'chain_path':map(lambda x: os.path.join( trainset_chain_dir, x ), os.listdir(trainset_chain_dir))})
